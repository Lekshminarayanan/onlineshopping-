...
<td class="span4"><c:set var="contextRoot" value="${pageContext.request.contextPath }"></c:set><a class="btn btn-info" role="button" href="<c:url value="${contextRoot }/admin/updateProd?id=<c:out value="${p.pid }"></c:cout>"/>Edit</a>

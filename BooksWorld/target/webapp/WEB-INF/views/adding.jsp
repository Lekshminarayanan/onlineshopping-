...
<form method="post" action="<c:url value="/admin/saveSupp"/>" class="form-sign-in">
...
<form method="post" action="<c:url value="/admin/saveCat"/>" class="form-sign-in">
<span id="reauth-email" class="reauth-email"></span>
...
<form method="post" action="<c:url value="/admin/saveProduct" />" class="form-sign-in" enctype="multipart/form-data">
<span id="reauth-email" class="reauth-email"></span>
